...
DEFAULT_CONFIG_PATH = Path.home() / ".config" / "miniCAH" / "config.toml"
PROJECT_CONFIG_NAME = ".miniCAH.toml"
...
ENV_PROVIDER = "MINI-CAH_PROVIDER"
ENV_API_KEY = "MINI-CAH_API_KEY"
ENV_BASE_URL = "MINI-CAH_BASE_URL"
ENV_MODEL = "MINI-CAH_MODEL"
...
LEGACY_ENV_NAMES = {
    "openai": {
        "api_key": ("MINI-CAH_OPENAI_API_KEY", "OPENAI_API_KEY"),
        "base_url": ("MINI-CAH_OPENAI_API_BASE", "OPENAI_API_BASE", "OPENAI_BASE_URL"),
        "model": ("MINI-CAH_OPENAI_MODEL", "OPENAI_MODEL"),
    },
    "anthropic": {
        "api_key": (
            "MINI-CAH_ANTHROPIC_API_KEY",
            "ANTHROPIC_API_KEY",
            "MINI-CAH_RIGHT_CODES_API_KEY",
            "RIGHT_CODES_API_KEY",
            "MINI-CAH_OPENAI_API_KEY",
            "OPENAI_API_KEY",
        ),
        "base_url": (
            "MINI-CAH_ANTHROPIC_API_BASE",
            "ANTHROPIC_API_BASE",
            "ANTHROPIC_BASE_URL",
        ),
        "model": ("MINI-CAH_ANTHROPIC_MODEL", "ANTHROPIC_MODEL"),
    },
    "deepseek": {
        "api_key": ("MINI-CAH_DEEPSEEK_API_KEY", "DEEPSEEK_API_KEY"),
        "base_url": (
            "MINI-CAH_DEEPSEEK_API_BASE",
            "DEEPSEEK_API_BASE",
            "DEEPSEEK_BASE_URL",
        ),
        "model": ("MINI-CAH_DEEPSEEK_MODEL", "DEEPSEEK_MODEL"),
    },
}
...
def resolve_provider_config(
    ...
    *,
    ...
    protocol = _first_value(
        None,
        os.environ.get("MINI-CAH_PROTOCOL"),
        profile_values.get("protocol"),
        legacy_env.get("MINI-CAH_PROTOCOL"),
...
def _read_config_file(path: Path) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f"invalid MiniCAH config file {path}: {exc}") from exc
    except OSError as exc:
        raise ValueError(f"could not read MiniCAH config file {path}: {exc}") from exc
