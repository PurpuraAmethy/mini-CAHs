...
SKILL_FILE_CREATION_GUIDE = """When creating MiniCAH skill files at .miniCAH/skills/<name>/SKILL.md or skills/<name>/SKILL.md, use frontmatter:
---
name: audit
...
class Skill:
    ...
    def render(self, arguments=""):
        ...
        replacements = {
            ...
            "${MINI-CAH_SKILL_DIR}": self.skill_root,
...
def discover_skills(root, home=None):
    ...
    search_roots = [
        (Path(home or Path.home()) / ".miniCAH" / "skills", "user"),
        (Path(root) / "skills", "project"),
        (Path(root) / ".miniCAH" / "skills", "project"),
    ]
