...
SLASH_COMMANDS: tuple[SlashCommand, ...] = (
    ...
    SlashCommand("skills", "/skills", "List available MiniCAH skills.", ("sk",)),
    SlashCommand("skill", "/skill <name> [args]", "Load and run a MiniCAH skill."),
    ...
    SlashCommand("exit", "/exit", "Exit MiniCAH.", ("quit",)),
)
